...
export const presets: CompressionPreset[] = [
  {
    ...
    settings: { format: 'png', quality: 100, stripMetadata: true }
  },
  {
    id: 'high-quality',
    label: 'High Quality',
    description: 'Great visual quality with JPEG.',
    settings: { format: 'jpeg', quality: 88, stripMetadata: true }
  },
  {
    id: 'webp',
    label: 'WebP',
    description: 'Balanced modern format for web usage.',
    settings: { format: 'webp', quality: 82, stripMetadata: true }
  },
  {
    id: 'avif',
    label: 'AVIF',
    description: 'Maximum compression for modern browsers.',
    settings: { format: 'avif', quality: 60, stripMetadata: true }
  },
  {
    id: 'blog',
    label: 'Blog Optimized',
    description: 'Fast-loading article images.',
    settings: { format: 'webp', quality: 74, stripMetadata: true }
  },
  {
    id: 'social',
    label: 'Social Optimized',
    description: 'High-impact visuals tuned for social feeds.',
    settings: { format: 'jpeg', quality: 80, stripMetadata: true }
  }
];
